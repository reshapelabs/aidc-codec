...
| GS1-CMP-003 | Composite Transfer | Composite packet parsing yields structured AI element semantics | In | PARTIAL | `parses_composite_packet_with_valid_separator`, `ean13_composite_decode_parses_cc_ai_semantics` | `src/parser/gs1.rs`, `src/parser/mod.rs` | Parses CC AI semantics; linear-primary semantic model/validation is still limited. |
